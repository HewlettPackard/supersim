...
u32 ReadWriteMSD::minMessageSize() const {
  return minMessageSize_;
}

u32 ReadWriteMSD::maxMessageSize() const {
  return maxMessageSize_;
}

u32 ReadWriteMSD::nextMessageSize() {
...
u32 ReadWriteMSD::nextMessageSize(const Message* _msg) {
