 ...
 */
#include "traffic/continuous/TornadoCFP.h"
...
TEST(TornadoCFP, dimension_1_3d) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  TornadoCFP* tp;
...
TEST(TornadoCFP, dimension_1_3d_1) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  TornadoCFP* tp;
