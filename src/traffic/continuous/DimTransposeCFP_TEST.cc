 ...
 */
#include "traffic/continuous/DimTransposeCFP.h"
...
TEST(DimTransposeCFP, no_enabled_dims) {
...
TEST(DimTransposeCFP, enabled_dims_0_1) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  DimTransposeCFP* tp;
...
TEST(DimTransposeCFP, enabled_dims_0_2) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  DimTransposeCFP* tp;
