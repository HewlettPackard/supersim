 ...
 */
#include "traffic/continuous/DimComplementReverseCFP.h"
...
DimComplementReverseCFP::DimComplementReverseCFP(
...
u32 DimComplementReverseCFP::nextDestination() {
  return dest_;
}

registerWithFactory("dim_complement_reverse", ContinuousTrafficPattern,
                    DimComplementReverseCFP, CONTINUOUSTRAFFICPATTERN_ARGS);
