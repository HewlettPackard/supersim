 ...
 */
#include "traffic/continuous/RandomExchangeQuadrantCFP.h"
...
TEST(RandomExchangeQuadrantCFP, evenSpread) {
  ...
  std::vector<RandomExchangeQuadrantCFP*> tps(numTerminals);
  for (u32 idx = 0; idx < numTerminals; idx++) {
    tps.at(idx) = new RandomExchangeQuadrantCFP(
