 ...
 */
#ifndef TRAFFIC_CONTINUOUS_DIMCOMPLEMENTREVERSECTP_H_
#define TRAFFIC_CONTINUOUS_DIMCOMPLEMENTREVERSECTP_H_
...
#endif  // TRAFFIC_CONTINUOUS_DIMCOMPLEMENTREVERSECTP_H_
