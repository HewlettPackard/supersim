 ...
 */
#ifndef TRAFFIC_CONTINUOUS_RANDOMEXCHANGENEIGHBORCTP_H_
#define TRAFFIC_CONTINUOUS_RANDOMEXCHANGENEIGHBORCTP_H_
...
#endif  // TRAFFIC_CONTINUOUS_RANDOMEXCHANGENEIGHBORCTP_H_
