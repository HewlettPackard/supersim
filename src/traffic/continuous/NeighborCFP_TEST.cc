 ...
 */
#include "traffic/continuous/NeighborCFP.h"
...
TEST(NeighborCFP, dimension_0_right) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  NeighborCFP* tp;
...
TEST(NeighborCFP, dimension_0_left) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  NeighborCFP* tp;
...
TEST(NeighborCFP, dimension_1_left) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  NeighborCFP* tp;
...
TEST(NeighborCFP, dimension_1_left_3d) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  NeighborCFP* tp;
...
TEST(NeighborCFP, dimension_1_left_3d_1) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  NeighborCFP* tp;
