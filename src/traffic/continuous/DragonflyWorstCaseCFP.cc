 ...
 */
#include "traffic/continuous/DragonflyWorstCaseCFP.h"

#include <factory/Factory.h>

#include <cassert>

DragonflyWorstCaseCFP::DragonflyWorstCaseCFP(
...
u32 DragonflyWorstCaseCFP::nextDestination() {
...
registerWithFactory("dragonfly_worstcase", ContinuousTrafficPattern,
                    DragonflyWorstCaseCFP, CONTINUOUSTRAFFICPATTERN_ARGS);
