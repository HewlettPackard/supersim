...
#include "traffic/continuous/DimBisectionStressCFP.h"
#include "test/TestSetup_TEST.h"

TEST(DimBisectionStressCFP, parity) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  DimBisectionStressCFP* tp;
...
TEST(DimBisectionStressCFP, half) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  DimBisectionStressCFP* tp;
...
TEST(DimBisectionStressCFP, quadrant) {
  TestSetup test(1, 1, 0xBAADF00D);
  u32 src, dst, numTerminals;
  Json::Value settings;
  DimBisectionStressCFP* tp;
