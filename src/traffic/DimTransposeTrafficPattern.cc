...
DimTransposeTrafficPattern::DimTransposeTrafficPattern(
...
u32 DimTransposeTrafficPattern::nextDestination() {
  return dest_;
}

registerWithFactory("dim_transpose", TrafficPattern,
                    DimTransposeTrafficPattern, TRAFFICPATTERN_ARGS);
