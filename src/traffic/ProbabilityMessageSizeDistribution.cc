...
u32 ProbabilityMessageSizeDistribution::minMessageSize() const {
  return *std::min_element(messageSizes_.cbegin(), messageSizes_.cend());
}

u32 ProbabilityMessageSizeDistribution::maxMessageSize() const {
  return *std::max_element(messageSizes_.cbegin(), messageSizes_.cend());
}

u32 ProbabilityMessageSizeDistribution::nextMessageSize() {
