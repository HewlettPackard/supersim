...
#ifndef NETWORK_SLIMFLY_INJECTIONALGORITHMFACTORY_H_
#define NETWORK_SLIMFLY_INJECTIONALGORITHMFACTORY_H_
...
#endif  // NETWORK_SLIMFLY_INJECTIONALGORITHMFACTORY_H_
