 ...
 */
#ifndef NETWORK_FOLDEDCLOS_INJECTIONALGORITHMFACTORY_H_
#define NETWORK_FOLDEDCLOS_INJECTIONALGORITHMFACTORY_H_
...
#endif  // NETWORK_FOLDEDCLOS_INJECTIONALGORITHMFACTORY_H_
