...
class MinimalRoutingAlgorithm : public RoutingAlgorithm {
 public:
 ...
 private:
  ...
  void routeToRemoteGroup(u32 _globalOffset, u32 _thisRouter, u32 _Rc,
                          bool _indirectGlobals);

  bool randomizedGlobal_;
  u32 rcs_;
  u32 localPortBase_;
  u32 globalPortBase_;
...
#endif  // NETWORK_DRAGONFLY_MINIMALROUTINGALGORITHM_H_
